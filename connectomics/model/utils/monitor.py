...
class Monitor(object):
    ...
    def __init__(self, cfg, log_path='', log_opt=[1,1,0,1], vis_opt=[0,8], iter_num=[10,100], 
        ...
        # self.vis = Visualizer(cfg, vis_opt[0], vis_opt[1], do_2d) # it is responsible for visualization
    ...
    def visualize(self, volume, label, output, iter_total): # TODO: code 到底监视了什么？
